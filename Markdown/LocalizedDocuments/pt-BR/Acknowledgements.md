...
Muito obrigado a todos que usam o Mac Mouse Fix e compartilham feedback. É incrível, e extremamente motivador, ver tantas pessoas aproveitando e interagindo com algo que eu criei.

Quero agradecer especialmente às pessoas e aos projetos mencionados neste documento.

<a name="translations"></a> 
## 🌏 Traduções

Obrigado por levar o Mac Mouse Fix para pessoas ao redor do mundo!

- 🇨🇳 Traduções para o chinês por  
...
- 🇰🇷 Traduções para o coreano por [@jeongtae](https://github.com/jeongtae)
- 🇻🇳 Traduções para o vietnamita por [@nghlt](https://github.com/nghlt)
- 🇧🇷 Brazilian Portuguese translations by 
    - **Eduardo Rodrigues**
    - [@denini08](https://github.com/denini08)
- 🇫🇷 Traduções para o francês por [@DimitriDR](https://github.com/DimitriDR)
- 🇹🇷 Traduções para o turco por  
  - [@hasanbeder](https://github.com/hasanbeder)  
  - [@erentomurcuk](https://github.com/erentomurcuk)
- 🇨🇿 Traduções para o tcheco por [Petr Pavlík](http://www.petrpavlik.com)
- 🇷🇺 Traduções para o russo por [ETMH](https://t.me/sos_soon_ok)
- 🇪🇸 Traduções para o espanhol por [@manghidev](https://github.com/manghidev)
- 🇵🇱 Traduções para o polonês por **Jakub** (Tradução do site)


<!-- 
  Old stuff from Money section:

  Thanks so much to everyone who bought me a milkshake and to all 41300+ people who bought Mac Mouse Fix! Ya'll are the bomb. Thanks to you I can spend lots of time on sth I love doing.
...
Muito obrigado a todos que me pagaram um milk-shake e a todas as 41300+ pessoas que compraram o Mac Mouse Fix.
...
❤️ Patrocinadores no GitHub

Muito obrigado a [todos](https://github.com/sponsors/noah-nuebling#sponsors) por me apoiarem no GitHub! Com sorte, um dia consigo montar minha própria fábrica de milk-shake graças a vocês. 😄

<a name="paypal-donations"></a> 
### ✨ Doações via PayPal

Muitas pessoas generosas me pagaram milk-shakes no PayPal quando o Mac Mouse Fix ainda era totalmente gratuito.

Se você é uma delas, clique [aqui](https://redirect.macmousefix.com/?locale=pt-BR&target=mmf-apply-for-milkshake-license) para receber uma **licença gratuita**!
...
**Softwares** que inspiraram o Mac Mouse Fix:

- [SteerMouse](https://plentycom.jp/en/steermouse/index.html) – Software pioneiro para mouse no Mac, que inspirou muitos recursos. Houve momentos em que pensei "isso provavelmente não é possível", mas então vi "opa, o SteerMouse faz isso", e três anos depois consegui implementar também.
- [Calftrail Touch](https://github.com/calftrail/Touch) – A base do trabalho de *engenharia reversa* que tornou possível a simulação de trackpad do Mac Mouse Fix, considerada a melhor da categoria e única no seu tipo!
- [MOS](https://mos.caldis.me/) – A opção de **Alta Suavidade de Rolagem**, as **Configurações Específicas por Aplicativo** e outros recursos do Mac Mouse Fix foram inspirados no MOS.
- [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) – Copiei parte do código para uma implementação inicial do recurso *"Voltar/Avançar uma página no Safari e em outros apps"*, e também foi assim que descobri o projeto Calftrail Touch.
- [Gifski](https://github.com/sindresorhus/Gifski) – Inspirou fortemente o design e o conteúdo do [Readme.md](Readme.md) do Mac Mouse Fix.
- [Vue Issue Helper](https://new-issue.vuejs.org/) – Base para o design e a implementação técnica do [Assistente de Feedback do Mac Mouse Fix](https://noah-nuebling.github.io/mac-mouse-fix-feedback-assistant/).
